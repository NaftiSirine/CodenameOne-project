...
public class AjouterTypeAbo extends BaseForm{
    
    
    Form current;
    public AjouterTypeAbo(Resources res,int id_ab){
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(type.getText().equals("")) {
                    ...
                    TypeAbonnement t = new TypeAbonnement(String.valueOf(type.getText()).toString());
                    
                    System.out.println("data  Question == "+t);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                   
                    ServiceTypeAbo.getInstance().ajoutTypeAbo(t,id_ab);
