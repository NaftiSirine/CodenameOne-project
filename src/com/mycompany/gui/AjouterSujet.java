 ...
 * @author Moez
 */
public class AjouterSujet extends BaseForm {
    
    
    
    Form current;
    public AjouterSujet(Resources res,int id_t){
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(sujet.getText().equals("")) {
                    ...
                    Sujet s = new Sujet(String.valueOf(sujet.getText()
                        ).toString());
                    
                     System.out.println("data  Sujet == "+s);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                    ServiceSujet.getInstance().ajoutSujet(s,id_t);
                    
                    iDialog.dispose(); //na7io loading ba3d ma3mlna ajout
                    
                    //ba3d ajout net3adaw lel ListREclamationForm
                    new AjouterQuestion(res,id_t).show();
