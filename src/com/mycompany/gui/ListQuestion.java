 ...
 * @author Moez
 */
public class ListQuestion extends BaseForm {
    
    
    
    Form current;
    public ListQuestion(Resources res){
        ...
        // current = this; 
        data = ServiceQuestion.getInstance().affichageQuestions();
        ...
        for(Question rec : list ) {
             ...
             String question_contenu = rec.getContenu();
                ...
                Label left = new Label(rec.getContenu());
                ...
                Button btnSupprimer = new Button("Supprimer cette question");
                addStringValue("", btnSupprimer);
                
                Button btnModifier = new Button("Modifier cette question");
                ...
                btnSupprimer.addActionListener((e) -> {
                    ...
                    System.out.println("in supression buton");
                       ...
                       ServiceQuestion.getInstance().deleteQuestion(rec.getId());
                ...
                btnModifier.addActionListener((e) -> {
                    ...
                    System.out.println("in modifier buton");
                       ...
                       new ModifierQuestion(res,rec).show();
