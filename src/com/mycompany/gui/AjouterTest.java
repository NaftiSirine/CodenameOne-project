...
public class AjouterTest extends BaseForm {
    
    
    
    Form current;
    public AjouterTest(Resources res){
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(titre.getText().equals("")) {
                    ...
                    Test t = new Test(String.valueOf(titre.getText()
                        ).toString());
                    
                     System.out.println("data  Test == "+t);
                    ...
                    int id_t = ServiceTest.getInstance().ajoutTest(t);
                    ...
                    new AjouterSujet(res,id_t).show();
