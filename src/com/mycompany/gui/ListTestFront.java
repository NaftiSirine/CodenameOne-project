...
public class ListTestFront extends BaseForm {
    
    
    int note = 0;
    
    Form current;
    public ListTestFront(Resources res){
        ...
        for(Test rec : list ) {
             ...
             System.out.println("test  Test == "+rec.getTitre());
                ...
                Label test = new Label(rec.getTitre());
                ...
                for(Question test_questions : rec.getQuestions())
                {
                    ...
                    Button btnchoix1 = new Button(test_questions.getChoices().get(0).getContenu());
                    addStringValue("", btnchoix1);
                    Button btnchoix2 = new Button(test_questions.getChoices().get(1).getContenu());
                    addStringValue("", btnchoix2);
                    Button btnchoix3 = new Button(test_questions.getChoices().get(2).getContenu());
                    addStringValue("", btnchoix3);
                    ...
                    btnchoix1.addActionListener((e) -> {
                           ...
                           btnchoix1.setEnabled(false);
                            ...
                            if(test_questions.getChoices().get(0).getStringetat() == "true")
                            rec.increment_note();
                            
                            System.out.println("mchi ?"+rec.getNote());
                            

                    });
                    btnchoix2.addActionListener((e) -> {
                           ...
                           btnchoix1.setEnabled(false);
                            ...
                            if(test_questions.getChoices().get(1).getStringetat() == "true")
                            rec.increment_note();
                ...
                Button btnAjouter = new Button("submit");
                addStringValue("", btnAjouter);
                
                btnAjouter.addActionListener((e) -> {
                    String string_note = String.valueOf(rec.getNote());
                        
                 Dialog.show("Votre note est ",string_note,"OK",null);
