 ...
 * @author Moez
 */
public class ListChoix extends BaseForm {
    
    
    
    Form current;
    public ListChoix(Resources res){
        ...
        ArrayList<Choix> data = new ArrayList<>(); 
        Form hi = new Form("Toolbar", new BoxLayout(BoxLayout.Y_AXIS));
         
        // current = this; 
        data = ServiceChoix.getInstance().affichageChoix();
        ...
        Choix u = new Choix(); 
        u.setContenu(data.get(i).getContenu()); 
        ...
        ArrayList<Choix>list = ServiceChoix.getInstance().affichageChoix();
        ...
        for(Choix rec : list ) {
             ...
             System.out.println("test  Question == "+rec.getContenu());
             
             
             String question_contenu = rec.getContenu();
            
                TextField firstName = new TextField(question_contenu);
        
                Button btnAjouter = new Button(rec.getContenu());
                addStringValue("", btnAjouter);
                
                Button btnSupprimer = new Button("Supprimer cette choix");
                addStringValue("", btnSupprimer);
                
                Button btnModifier = new Button("Modifier cette choix");
                ...
                btnSupprimer.addActionListener((e) -> {
                    ...
                    System.out.println("in supression buton");
                       ...
                       ServiceChoix.getInstance().deleteChoix(rec.getId());
                ...
                btnModifier.addActionListener((e) -> {
                    ...
                    System.out.println("in modifier buton");
                       ...
                       new ModifierChoix(res,rec).show();
    ...
    private void addButton(Choix rec , Resources res) {
