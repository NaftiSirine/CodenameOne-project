...
public class ListUser extends BaseForm{
    ...
    public ListUser(Resources res){
        ...
        ArrayList<Utilisateur> data = new ArrayList<>(); 
        Form hi = new Form("Toolbar", new BoxLayout(BoxLayout.Y_AXIS));
         
        // current = this; 
       
        data=ServiceUtilisateur.getInstance().affichageUsers();
        ...
        a.setEmail(data.get(i).getEmail());
        a.setMotdepasse(data.get(i).getMotdepasse()); 
        a.setEtat(data.get(i).getEtat());
        ...
        ArrayList<Utilisateur>list = ServiceUtilisateur.getInstance().affichageUsers();
        ...
        for(Utilisateur rec : list ) {
             ...
             System.out.println("user   == "+rec.getNom());
             
             
        
                Button btnEmail = new Button(rec.getEmail());
                addStringValue("", btnEmail);
                
                Button btnPassword= new Button(rec.getMotdepasse());
                addStringValue("", btnPassword);
                
               
                Button btnSupprimer = new Button("Bloquer cet utilisateur");
                addStringValue("", btnSupprimer);
                
                Button btnModifier = new Button("Modifier cet utilisateur");
                ...
                btnSupprimer.addActionListener((e) -> {
                    ...
                    System.out.println("in supression buton");
                       ...
                       ServiceUtilisateur.getInstance().deleteUser(rec.getId());
