            ...
            try {
                ...
                if(email.getText().equals("")) {
                    ...
                    //njibo iduser men session (current user)
                                         ...
                                         Utilisateur a = new Utilisateur(String.valueOf(email.getText()
                        ).toString(),
                   ...
                   // System.out.println("type of cout = "+int_cout);
                    ...
                    System.out.println("data  user == "+a);
                    
                    
                    //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base 
                  
                    int id_ab = ServiceUtilisateur.getInstance().ajoutUser(a);
                    
                    iDialog.dispose(); //na7io loading ba3d ma3mlna ajout
                     // Dialog.show("Success","user is saved","OK",null);
